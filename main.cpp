...
FPAddFunctionalUnit fpFu(config.fu_fp_mult[1]);
FPMultFunctionalUnit fpMulFu(config.fu_fp_mult[1]);
cdb bus;
		...
		for(unsigned int i = 0; i < outputInstructions.size(); i++){
			switch(outputInstructions[i]->op_code){
				...
				case add_d:
					...
					break;
				case add_i:
					outFile << "ID = " << outputInstructions[i]->instructionId << " add_i " << "R" << outputInstructions[i]->dest << ", R" << outputInstructions[i]->r_left_operand << ", R" << outputInstructions[i]->immediate << "\t" << output.tDiag[i][1] << "-" << output.tDiag[i][2] << " " << output.tDiag[i][3] << "-" << output.tDiag[i][4] << " " << output.tDiag[i][5] << "-" << output.tDiag[i][6] << " " << output.tDiag[i][7] << "-" << output.tDiag[i][8] << " " << output.tDiag[i][9] << "-" << output.tDiag[i][10] << endl;
					break;
				case sub:
